...
import actualSpot.models
# from actualSpot.models import Vehicle
...
class SoenModel(models.Model):
    ...
    checking = models.BooleanField(verbose_name="選択フラグ（ゴメン今のところ使いません⇒）", null=True, blank=True)#, default=False
    code = models.IntegerField(verbose_name="検索番号", null=True, blank=True)
    ...
    file1 = models.FileField(verbose_name="Link1健康保険", max_length=100, null=True, blank=True,
                             default="\\Soensv\\共有フォルダ\\新しいフォルダー")
    ...
    retirementCooperation = models.CharField(verbose_name="建退協", max_length=100, null=True, blank=True,
                                             choices=retirementCooperation_list)
    file4 = models.FileField(verbose_name="Link4建退協", max_length=100, null=True, blank=True)
    # specialEducation= models.ForeignKey(SpecialEducationModel,null=True,blank=True,on_delete=models.PROTECT)
    ...
    # skillTraning= models.ForeignKey(SkillTraningModel,null=True,blank=True,on_delete=models.PROTECT)
    ...
    # licence=models.ForeignKey(LicenceModel,null=True,blank=True,on_delete=models.PROTECT)
    ...
    constractionPermit = models.CharField(verbose_name="建設業許可業種", max_length=100, null=True, blank=True,
                                          choices=permit_list)
    constractionPermit_chuji = models.CharField(verbose_name="建設業許可_大臣・知事", max_length=100, null=True, blank=True,
                                                choices=chiji_list)
    constractionPermit_ippan = models.CharField(verbose_name="建設業許可_特定・一般", max_length=100, null=True, blank=True,
                                                choices=ippan_list)
    ...
    No_1_specific_skill_foreigner = models.CharField(verbose_name="一号特定技能外国人", max_length=100, null=True, blank=True,
                                                     choices=free_list)
    ...
    carryonMachine = models.CharField(verbose_name="持込機械", max_length=100, null=True, blank=True,
                                      choices=carryonMachine_list)
